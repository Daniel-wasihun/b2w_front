  ...
  return (
    <section className="py-24 bg-muted/50">
       <div className="container mx-auto px-6">
          <div className="bg-card p-12 md:p-24 rounded-[4rem] text-center border border-border/50 shadow-2xl relative overflow-hidden group">
             ...
             <Link href="/register">
                <Button className="h-16 px-12 rounded-2xl bg-primary text-white font-bold text-lg hover:scale-105 transition-transform shadow-glow-primary border-none">
                   Join the Initiative
                </Button>
             </Link>
          </div>
