  ...
  return (
    <section className="py-24 bg-muted/50">
      <div className="container mx-auto px-6">
        <div className="bg-card rounded-[3rem] p-12 md:p-24 text-center border border-border/50 shadow-2xl relative overflow-hidden group">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
             <Link href="/register">
               <Button size="lg" className="h-16 px-12 rounded-2xl text-lg font-bold shadow-glow-primary">
                  Register Now
               </Button>
             </Link>
             <Link href="/contact">
               <Button size="lg" variant="outline" className="h-16 px-12 rounded-2xl text-lg font-bold">
                  Talk to Us
               </Button>
             </Link>
          </div>
