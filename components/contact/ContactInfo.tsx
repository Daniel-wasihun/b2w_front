...
export const ContactInfo = () => {
  return (
    <div className="space-y-8">
       <div className="bg-primary p-12 rounded-[8px] text-white space-y-10 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-32 h-32 bg-secondary/20 blur-[60px] rounded-[8px]" />
          ...
          <div className="space-y-8">
             {infoItems.map((item, i) => (
               <div key={i} className="flex items-center space-x-6">
                  <div className="w-12 h-12 rounded-[8px] bg-white/10 flex items-center justify-center shrink-0">
          ...
          <div className="pt-10 border-t border-white/10 flex space-x-4">
             {[Share2, MessageCircle, Heart].map((Icon, i) => (
               <div key={i} className="w-10 h-10 rounded-[8px] bg-white/10 flex items-center justify-center hover:bg-secondary hover:text-primary transition-all cursor-pointer">
                  <Icon size={18} />
               </div>
             ))}
          </div>
       ...
       <div className="bg-card p-10 rounded-[8px] border border-border/50 shadow-sm text-center space-y-6">
          <div className="w-16 h-16 rounded-[8px] bg-secondary/10 flex items-center justify-center text-secondary mx-auto">
             <Globe size={32} />
          </div>
          ...
          <Button variant="outline" className="w-full rounded-[8px] border-secondary/20 text-secondary hover:bg-secondary/5">View Network</Button>
       </div>
    </div>
  );
};
