  ...
  return (
    <section className="pb-24">
       <div className="container mx-auto px-6">
          <div className="h-[500px] bg-card rounded-[5px] overflow-hidden border border-border/50 shadow-xl relative flex items-center justify-center">
             ...
             <div className="relative z-10 bg-white/80 backdrop-blur-xl p-12 rounded-[5px] shadow-2xl border border-white text-center max-w-sm">
                <div className="w-16 h-16 rounded-[5px] bg-primary text-white flex items-center justify-center mx-auto mb-6 shadow-glow-primary">
                   <MapPin size={32} />
                </div>
