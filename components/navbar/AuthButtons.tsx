    ...
    <div className="flex items-center space-x-4">
      <Link href="/login">
        <Button 
          variant="ghost" 
          className={cn(
            "font-bold capitalize text-xs h-11 px-6 rounded-[8px] transition-all duration-300",
            scrolled 
      ...
      <Link href="/donate">
        <Button 
          className={cn(
            "font-bold capitalize text-xs h-11 px-7 rounded-[8px] shadow-lg transition-all duration-500",
            scrolled 
