  ...
  return (
    <div className="relative group/explore">
      ...
      <div className="absolute top-full left-0 pt-4 opacity-0 translate-y-2 pointer-events-none group-hover/explore:opacity-100 group-hover/explore:translate-y-0 group-hover/explore:pointer-events-auto transition-all duration-300 z-50">
        ...
        <div className="bg-background border border-border/50 rounded-[8px] p-2 shadow-2xl min-w-[200px] overflow-hidden relative z-20">
          ...
          {[
            ...
            <Link 
              ...
              href={item.href}
              className={cn(
                "flex items-center px-4 py-3 rounded-[8px] transition-all hover:bg-muted group/item",
                pathname === item.href ? "text-primary bg-primary/5" : "text-foreground/70"
              )}
            >
              <div className={cn(
                "w-8 h-8 rounded-[8px] flex items-center justify-center mr-3 transition-colors",
