    ...
    <div className="hidden lg:block space-y-10">
       <div className="bg-card p-8 rounded-[2rem] border border-border/50 shadow-sm">
          ...
          <input 
            ...
            className="w-full h-12 bg-muted rounded-xl px-4 text-sm outline-none border border-border focus:border-primary/50"
          />
       </div>
       ...
       <div className="bg-primary/5 p-8 rounded-[2rem] border border-primary/10">
          ...
          <Button className="w-full rounded-xl shadow-glow-primary">Subscribe</Button>
       </div>
    </div>
  );
};
