  ...
  return (
    <section className="pb-24 pt-12 bg-muted/50">
       <div className="container mx-auto px-6">
          <div className="bg-card p-12 md:p-20 rounded-[5px] border border-border/50 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-12 relative overflow-hidden group">
             ...
             <div className="flex flex-col sm:flex-row gap-4 relative z-10 w-full md:w-auto">
                <Link href="/events">
                  <Button size="lg" variant="secondary" className="h-16 px-10 rounded-[5px] font-bold shadow-glow-secondary text-primary border-none">
                    View Calendar
                  </Button>
                </Link>
                <Link href="/contact">
                  <Button size="lg" variant="outline" className="h-16 px-10 rounded-[5px] font-bold border-border text-primary hover:bg-muted">
                    Get Support
                  </Button>
                </Link>
             </div>
