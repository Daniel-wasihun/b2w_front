    ...
    <div className="columns-1 md:columns-2 lg:columns-3 gap-8 space-y-8">
       {items.map((item) => (
         <motion.div
           ...
           className="relative group cursor-pointer overflow-hidden rounded-[2.5rem] bg-card border border-border/50 break-inside-avoid shadow-sm hover:shadow-2xl transition-all duration-500"
